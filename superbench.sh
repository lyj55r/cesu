...
benchinit() {
	...
	if [ -f /etc/redhat-release ]; then
	    release="centos"#!/usr/bin/env bash#!/usr/bin/env bash#!/usr/bin/env bash
#
# Description: Auto system info & I/O test & network to China script
#
# Copyright (C) 2017 - 2018 Oldking <oooldking@gmail.com>
...
benchinit() {
	# check release
	if [ -f /etc/redhat-release ]; then
	    release="centos"#!/usr/bin/env bash#!/usr/bin/env bash
#
# Description: Auto system info & I/O test & network to China script
#
# Copyright (C) 2017 - 2018 Oldking <oooldking@gmail.com>
...
benchinit() {
	# check release
	if [ -f /etc/redhat-release ]; then
	    release="centos"#!/usr/bin/env bash
#
# Description: Auto system info & I/O test & network to China script
#
# Copyright (C) 2017 - 2018 Oldking <oooldking@gmail.com>
